...
const double TICKS_PER_REVOLUTION = 134.4; // For reference purposes.
const double WHEEL_RADIUS = 0.05564; // Wheel radius in meters
const double WHEEL_BASE = 0.622; // Center of left tire to center of right tire
const double TICKS_PER_METER = 1553; // Original was 2800
