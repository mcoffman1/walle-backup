...
def scan_callback(msg):
    ...
    desired_min_angle = -0.5 * 3.14159   # -90 degrees
    ...
    filtered_ranges = msg.ranges[desired_min_index:desired_max_index+1]

    # Create a new LaserScan message with the filtered data
    filtered_msg = LaserScan()
    filtered_msg.header = msg.header
    filtered_msg.angle_min = desired_min_angle
    filtered_msg.angle_max = desired_max_angle
